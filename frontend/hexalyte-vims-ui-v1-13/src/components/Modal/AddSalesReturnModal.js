                                        ...
                                        <div className="flex-1 grid grid-cols-1 md:grid-cols-4 gap-3">
                                            ...
                                            <div>
                                                ...
                                                <select
                                                    ...
                                                    className={`w-full px-3 py-2 text-sm border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${errors[`item_${index}_product`] ? 'border-red-300' : 'border-gray-300'
                                                        }`}
                                                >
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    className={`w-full px-3 py-2 text-sm border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${errors[`item_${index}_quantity`] ? 'border-red-300' : 'border-gray-300'
                                                        }`}
                                                />
